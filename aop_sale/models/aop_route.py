...
class AopRoute(models.Model):
    ...
    aop_id = fields.Many2one('delivery.carrier', string='Delivery carrier')
...
class AopRouteLine(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', 'Src partner')
    des_partner_id = fields.Many2one('res.partner', 'Destination')
