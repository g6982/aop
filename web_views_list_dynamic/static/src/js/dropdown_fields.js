/* /web_views_list_dynamic/static/src/js/dropdown_fields.js defined in bundle 'web.assets_backend' */
odoo.define('web_views_list_dynamic.FieldDropdown', function (require) {
    "use strict";
    ...
    var FieldDropdown = Widget.extend({
        // template: 'web_views_list_dynamic.FieldsDropdown',
        fieldTemplate: 'web_views_list_dynamic.FieldsDropdownItems',
        events: {
